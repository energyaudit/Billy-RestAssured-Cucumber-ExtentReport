...
#    Then response status line should be 'HTTP/1.1 200 OK'
  @runnow
  Scenario: Demo Util methods in demo feature
#    Given user get api first
  ...
  @runnow
  Scenario: Demo Util methods patch in demo feature
    Given user patch to change a data
    And create new payload.json file
    And post from payload file
